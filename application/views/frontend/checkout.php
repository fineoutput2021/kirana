                        ...
                        <div class="ltn__checkout-single-content-info">
                            <form action="javascript:void;" id="pay" >
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-item input-item-name ltn__custom-icon">
                                            <input type="text" maxlength="6" onkeydown="if(event.key==='.'){event.preventDefault();}"  oninput="event.target.value = event.target.value.replace(/[^0-9]*/g,'');" name="lastname" id="pincode" placeholder="Pincode">
                                        </div>
                                    </div>
